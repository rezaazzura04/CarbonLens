"""
CarbonLens — Navigation configuration.

Single source of truth for all destinations, tab definitions,
...
# ── seven-destination route registry ──────────────────────────────────────
...
def get_accent(destination_id: str) -> str:
    ...
    return ROUTE_MAP.get(destination_id, {}).get("accent", "#037C38")


# ── Tab definitions ───────────────────────────────────────────────────────────
# Only Reporting & Compliance currently uses a tabbed sub-layout — the other
# six destinations use a single-page scrolling section layout instead.
