"""
CarbonLens — Platform configuration registry.
...
SCOPE3_EMISSION_FACTORS: dict[str, dict] = {
    "cat1_purchased_goods": {
        ...
        "unit": "kg CO2e / USD",
        "source": "USEEIO v2.0",
        "note": "Proxy factor — USEEIO sector-average spend basis, not "
                "supplier- or product-specific. Independent validation "
                "recommended before formal disclosure.",
    },
    "cat2_capital_goods": {
    ...
    "cat3_energy_upstream": {
        ...
        "unit": "kg CO2e / kWh",
        "source": "DEFRA 2023",
        "note": "Proxy factor — DEFRA generic transmission/distribution "
                "loss average, not grid-specific.",
    },
    "cat4_transport_upstream": {
        "ef": 0.1,    # kg CO2e per tonne-km (road average)
        "unit": "kg CO2e / tonne-km",
        "source": "GLEC Framework v3",
        "note": "Proxy factor — GLEC road-freight average, not "
                "route- or carrier-specific.",
    },
    "cat5_waste": {
        "ef": 0.467,  # kg CO2e per kg waste (landfill average)
        "unit": "kg CO2e / kg",
        "source": "DEFRA 2023",
        "note": "Proxy factor — DEFRA generic landfill average, not "
                "waste-stream- or facility-specific.",
    },
    "cat6_business_travel": {
        "ef": 0.255,  # kg CO2e per km (average domestic flight)
        "unit": "kg CO2e / km",
        "source": "DEFRA 2023",
        "note": "Proxy factor — DEFRA average domestic-flight basis, not "
                "route- or aircraft-specific.",
    },
    "cat7_employee_commute": {
        "ef": 0.17,   # kg CO2e per km (passenger vehicle average)
        "unit": "kg CO2e / km",
        "source": "DEFRA 2023",
        "note": "Proxy factor — DEFRA average passenger-vehicle basis, not "
                "mode- or employee-specific.",
    },
    ...
    "cat12_end_of_life": {
        ...
        "unit": "kg CO2e / kg",
        "source": "DEFRA 2023",
        "note": "Proxy factor — DEFRA generic end-of-life average, not "
                "product- or disposal-route-specific.",
    },
...
INDUSTRY_BENCHMARKS_PROVENANCE: str = (
    "Illustrative sector intensity estimates compiled for CarbonLens (Phase 0 C5 fix). "
...
PAGE_COLORS: dict[str, dict[str, str]] = {
    "executive_summary":    {"accent": "#037C38", "light": "#E0EFE7"},
    "carbon_accounting":    {"accent": "#037C38", "light": "#E0EFE7"},
    "esg_analytics":        {"accent": "#3E7C8C", "light": "#E3EEF0"},
    "data_quality":         {"accent": "#D89A3D", "light": "#FBF1DF"},
    "reporting_compliance": {"accent": "#3E7C8C", "light": "#E3EEF0"},
    "decarbonization":      {"accent": "#037C38", "light": "#E0EFE7"},
    "governance":           {"accent": "#0F3D2E", "light": "#DDE7E1"},
}
