...
def test_build_esg_provenance_rows_schema():
    ...
    rows = _build_esg_provenance_rows("Phase4", 100.0, 8, 8)
...
def test_build_esg_provenance_rows_weights():
    from pages.esg_analytics.page import _build_esg_provenance_rows
    rows = _build_esg_provenance_rows("Phase4", 75.0, 6, 8)
...
def test_provenance_rows_no_arithmetic():
    ...
    from pages.esg_analytics.page import _build_esg_provenance_rows
    rows_a = _build_esg_provenance_rows("Phase4", 100.0, 8, 8)
    rows_b = _build_esg_provenance_rows("Phase4", 100.0, 8, 8)
