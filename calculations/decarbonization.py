"""
CarbonLens — Decarbonization calculations.
...
def _default_pln_ef() -> float:
    """Canonical national PLN grid EF (Kepmen ESDM No. 18/2023) — resolved
    lazily so this module never hardcodes a second, driftable copy of the
    constant (Fix: 0.716 vs canonical 0.7160 mismatch)."""
